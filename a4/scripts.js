...
function Remember(){
    ...
    // this if statement will only trigger if the user has checked the remember me checkbox    
    if(document.getElementById("remember").checked){
        
        // changing the text displayed on the checkbox to "forget me"
        document.getElementById("remember_lab").innerHTML = "forget me";

        // storing thhe variables in local storage, including that the box is checked
        ...
        localStorage.setItem("phone", document.getElementById("user[mobile_number]").value);
...
function checkStorage(){
    ...
    if(localStorage.getItem("email") === null){
        ...
        console.log("here");
        document.getElementById("remember_lab").innerHTML = "forget me";
        // filling the appropriate fields with the values stored in local storage
        ...
        document.getElementById("user[mobile_number]").value = localStorage.getItem("phone");
