...
// checking if the "redirected" varialbe is set - this only occurs when comming from the "current bookings" page
    ...
    <body>
      <main id="recipt">
        ...
        <h1>Booking Confirmation</h1>
          ...
          <p>Booking time: &nbsp; <?php if(isset($_SESSION['booking_time'])){
            echo($_SESSION['booking_time']);
            
          } else{ date ("Y F d  H:i", filemtime($_SERVER['SCRIPT_FILENAME']));} ?></p>
          <br>
